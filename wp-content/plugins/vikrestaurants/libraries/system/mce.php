...
class VikRestaurantsTinyMCE
{
	...
	public static function registerShortcodesScript($plugin_array)
	{
		...
		$document->addScriptDeclaration("var VIKRESTAURANTS_SHORTCODES = " . json_encode($shortcodes) . ";");
		$document->addStyleSheet(VIKRESTAURANTS_CORE_MEDIA_URI . 'css/tinymce-shortcodes.css');

		$plugin_array['vre-shortcodes'] = VIKRESTAURANTS_CORE_MEDIA_URI . 'js/tinymce-shortcodes.js';
