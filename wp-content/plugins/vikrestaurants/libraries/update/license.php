...
class VikRestaurantsLicense
{
	...
	{
		return trim(get_option('vikrestaurants_license_key', ''));
	}
	...
	public static function setKey($key)
	{
		 ...
		 * @since 1.1
		 */
		JFactory::getApplication()->set('vikrestaurants_license_key', (string) $key, $network = true);
	}
	...
	{
		return trim(get_option('vikrestaurants_license_expdate', ''));
	}
	...
	public static function setExpirationDate($time)
	{
		 ...
		 * @since 1.1
		 */
		JFactory::getApplication()->set('vikrestaurants_license_expdate', $time, $network = true);
	}
	...
	{
		$hash = trim(get_option('vikrestaurants_license_hash', ''));
	...
	public static function setHash()
	{
		...
		update_option('vikrestaurants_license_hash', $hash);
	...
	{
		update_option('vikrestaurants_license_key', '');
		update_option('vikrestaurants_license_expdate', null);
		update_option('vikrestaurants_license_hash', '');
	}
