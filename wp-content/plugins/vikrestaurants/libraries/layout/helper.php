 ...
 * @since 1.0
 */
abstract class VikRestaurantsLayoutHelper
{
	/**
	...
	public static function renderSystemMessages(array $queue = null, $echo = true)
	{
		 ...
		 * ('groupsysmessages', 0)
		 */
		$should_be_grouped = VREFactory::getConfig()->getBool('groupsysmessages', true);
		...
		$layout = new JLayoutFile('html.system.messages', null, array('component' => 'com_vikrestaurants'));
	...
	public static function renderToolbar($bar = null, $echo = true)
	{
		...
		{
			// open toolbar
			$layout = new JLayoutFile('html.toolbar.open', null, array('component' => 'com_vikrestaurants'));
			...
			foreach ($bar->getButtons() as $button)
			{
				...
				$layoutId[] = null;
				// force component
				$layoutId[] = array('component' => 'com_vikrestaurants');
			...
			// close toolbar
			$layout = new JLayoutFile('html.toolbar.close', null, array('component' => 'com_vikrestaurants'));
	...
	public static function renderBody($html, $echo = true)
	{
		...
		// recover view from request
		$view = $input->get('view', $input->get('task'));

		$data = array(
			'html'  => $html,
			'class' => $view ? 'vikrestaurants-page-' . $view : '',
		);

		$layout = new JLayoutFile('html.system.body', null, array('component' => 'com_vikrestaurants'));
