 ...
 * @since 1.1
 */
class JDashboardWidgetVikRestaurantsRss extends JDashboardWidget
{
	/**
	...
	{
		// set up RSS reader
		$this->rss = VikRestaurantsBuilder::setupRssReader();
	}
	...
	{
		return __('VikRestaurants - RSS Feeds', 'vikrestaurants');
	}
	...
	public function canAccess($user = null)
	{
		...
		return $user->authorise('core.admin', 'com_vikrestaurants');
	}
	...
	protected function renderWidget($args)
	{
		...
		// create layout file
		$layout = new JLayoutFile('html.wpdash.rss.widget', null, array('component' => 'com_vikrestaurants'));
	...
	protected function renderForm($args)
	{
		...
		$document->addStyleDeclaration('#vik_restaurants_rss .postbox-container { width: 100% !important; }');
