...
/**
 * VikRestaurants plugin Shortcode model.
 *
 * @since 	1.0
 * @see 	JModelForm
 */
class VikRestaurantsModelShortcode extends JModelForm
{
	/**
	 * @override
	...
	public function getFormData()
	{
		...
		// get layout path
		$path = JPath::clean(VREBASE . '/views/' . $data->type . '/tmpl/default.xml');
		...
		$data->shortcode = JFilterOutput::shortcode('vikrestaurants', $args);
	...
	public function save(&$data)
	{
		...
		if ($res && $old)
		{
			...
			if ($post)
			{
				 ...
				 *
				 * @see vikrestaurants.php @ action:save_post
				 */
