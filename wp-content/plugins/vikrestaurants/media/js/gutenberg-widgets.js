(function(wp) {
	...
	/**
	 * Helper function used to convert a VikRestaurants widget into a block.
	 * 
	 * @param   object  manifest
	 * 
	 * @return  void
	 */
	window.vreRegisterBlockEditor = (manifest) => {
		/**
			...
			edit: (props) => {
				...
				manifest.form.forEach((fieldset, index) => {
					...
					fieldset.fields.forEach((field) => {
						...
						let fieldControl = window.vreCreateControlElement(field, props);
