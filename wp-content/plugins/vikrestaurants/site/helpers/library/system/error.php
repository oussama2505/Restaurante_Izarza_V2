...
if (!class_exists('UIErrorFactory'))
{
	...
	final class UIErrorFactory
	{
		 ...
		 * @return 	void
		 * 
		 * @deprecated 1.10  Use Use E4J\VikRestaurants\Http\Document::close() instead.
		 */
		public static function raiseError($code, $error = null)
		{
			E4J\VikRestaurants\Http\Document::getInstance()->close($code, $error);
		}
		 ...
		 * @throws 	Exception
		 * 
		 * @deprecated 1.10  Directly throw an Exception instead.
		 */
