 ...
 *
 * @since 1.8
 * @deprecated 1.10  Use E4J\VikRestaurants\Mail\Templates\Takeaway\CustomerMailTemplate instead.
 */
class VREMailTemplateTakeawayCustomer implements VREMailTemplate
{
	use VREMailTemplateadapter;

	/** @var E4J\VikRestaurants\Mail\Templates\Takeaway\CustomerMailTemplate */
	protected $adaptee;
	...
	{
		$this->adaptee = new E4J\VikRestaurants\Mail\Templates\Takeaway\CustomerMailTemplate($order, [
			'lang' => $langtag,
		]);
	}
}
