...
/**
 * Conditional text action adapter.
 *
 * @since 1.9
 */
abstract class ConditionalTextActionAware extends ConditionalTextManageableAware implements ConditionalTextAction
{
	/**
	 * @inheritDoc
	 */
	public function getName()
	{
		...
		// define language key
		$langKey = 'VRE_CONDITIONAL_TEXT_ACTION_' . strtoupper($id);
	...
	public function getDescription()
	{
		...
		// define language key
		$langKey = 'VRE_CONDITIONAL_TEXT_ACTION_' . strtoupper($id) . '_DESC';
