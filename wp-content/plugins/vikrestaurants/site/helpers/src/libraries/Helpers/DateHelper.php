...
namespace E4J\VikRestaurants\Helpers;
...
class DateHelper
{
	 ...
	 * @param   int     $hour  The hours to use.
	 * @param   int     $min   The minutes to use.
	 * @param   int     $sec   The seconds to use.
	 *
	...
	public static function getTimestamp($date, $hour = null, $min = null, $sec = null)
	{
		...
		{
			// use system format
			$format = \VREFactory::getConfig()->get('dateformat');
		}
