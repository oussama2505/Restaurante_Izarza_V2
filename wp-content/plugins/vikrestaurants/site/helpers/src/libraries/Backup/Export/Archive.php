...
class Archive
{
	 ...
	 * @return  bool
	 */
	public function addEmptyFolder(string $folder)
	{
	 ...
	 */
	public function addFile(string $src, string $dest)
	{
	 ...
	 */
	public function addBuffer(string $buffer, string $dest)
	{
		// build the destination path
		$dest = \JPath::clean($this->path . '/' . $dest);
	 ...
	 */
	public function compress(string $name = null)
	{
		...
		$status = \E4J\VikRestaurants\Archive\Factory::compress($this->path, $destination);
