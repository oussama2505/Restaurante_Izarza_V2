...
<div class="alert alert-<?php echo $type . (!empty($attrs['class']) ? ' ' . $attrs['class'] : ''); ?>"<?php echo $attrs_str; ?>>
	...
	{
		?>
		<button type="button" class="close" data-dismiss="alert" data-signature="<?php echo $this->escape($id); ?>" data-expdate="<?php echo $this->escape($expdate); ?>" aria-label="<?php echo $this->escape(JText::translate('JTOOLBAR_CLOSE')); ?>">
