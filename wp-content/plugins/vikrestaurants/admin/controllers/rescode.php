...
class VikRestaurantsControllerRescode extends VREControllerAdmin
{
	...
	public function add()
	{
		...
		if (!$user->authorise('core.create', 'com_vikrestaurants') || !$user->authorise('core.access.rescodes', 'com_vikrestaurants'))
		{
	...
	public function edit()
	{
		...
		// unset user state for being recovered again
		$app->setUserState('vre.rescode.data', []);

		// check user permissions
		if (!$user->authorise('core.edit', 'com_vikrestaurants') || !$user->authorise('core.access.rescodes', 'com_vikrestaurants'))
		{
	...
	public function save($copy = false)
	{
		...
		$args['sendmail'] = $input->get('sendmail', 0, 'uint');
		...
		// check user permissions
		if (!$user->authorise($rule, 'com_vikrestaurants') || !$user->authorise('core.access.rescodes', 'com_vikrestaurants'))
		{
		...
		$rescode = $this->getModel();

		// try to save arguments
		$id = $rescode->save($args);
		...
		$this->setRedirect('index.php?option=com_vikrestaurants&task=rescode.edit&cid[]=' . $id);
	...
	public function delete()
	{
		...
		// check user permissions
		if (!$user->authorise('core.delete', 'com_vikrestaurants') || !$user->authorise('core.access.rescodes', 'com_vikrestaurants'))
		{
