...
class VikRestaurantsControllerLangtktopping extends VREControllerAdmin
{
	...
	public function add()
	{
		...
		$app->setUserState('vre.langtktopping.data', []);
	...
	public function save()
	{
		...
		$langtopping = $this->getModel();

		// try to save arguments
		$id = $langtopping->save($args);
		...
		$this->setRedirect('index.php?option=com_vikrestaurants&task=langtktopping.edit&cid[]=' . $id);
