...
/**
 * VikRestaurants media language controller.
 *
 * @since 1.9
 */
class VikRestaurantsControllerLangmedia extends VREControllerAdmin
{
	/**
	...
	public function add()
	{
		...
		$app->setUserState('vre.langmedia.data', []);
		...
		$this->setRedirect('index.php?option=com_vikrestaurants&view=managelangmedia&image=' . $image);
	...
	public function edit()
	{
		...
		$this->setRedirect('index.php?option=com_vikrestaurants&view=managelangmedia&cid[]=' . $cid[0]);
	...
	public function savenew()
	{
		if ($this->save())
		{
			...
			$url = 'index.php?option=com_vikrestaurants&task=langmedia.add';
	...
	public function save()
	{
		...
		if (!$id)
		{
			...
			$url = 'index.php?option=com_vikrestaurants&view=managelangmedia';
		...
		$this->setRedirect('index.php?option=com_vikrestaurants&task=langmedia.edit&cid[]=' . $id);
	...
	public function cancel()
	{
		...
		$url = 'index.php?option=com_vikrestaurants&view=langmedia';
