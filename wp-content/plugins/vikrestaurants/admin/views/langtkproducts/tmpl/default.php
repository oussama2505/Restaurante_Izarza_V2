			...
			<tr class="row<?php echo $i % 2; ?>">
				...
				<td>
					<div class="td-primary">
						...
						{
							?>
							<a href="index.php?option=com_vikrestaurants&amp;task=langtkentry.edit&amp;cid[]=<?php echo (int) $row['id']; ?>">
								<?php echo $name; ?>
							</a>
							<?php
						}
...
?>
	...
	<input type="hidden" name="id_entry" value="<?php echo (int) $filters['id_entry']; ?>" />
	<input type="hidden" name="id_takeaway_menu" value="<?php echo (int) $filters['id_takeaway_menu']; ?>" />
