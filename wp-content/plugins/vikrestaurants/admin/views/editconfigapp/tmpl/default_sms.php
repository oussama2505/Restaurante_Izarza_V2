...
$tabs = [];
$tabs['VRE_SETTINGS_FIELDSET']  = $this->loadTemplate('sms_settings');
$tabs['VRE_TEMPLATES_FIELDSET'] = $this->loadTemplate('sms_template');
 ...
 * called "onDisplayViewConfigappSms". The event method receives the
 * view instance as argument.
 *
 * @since 1.9
 */
$forms = $this->onDisplayView('Sms', $setup);
