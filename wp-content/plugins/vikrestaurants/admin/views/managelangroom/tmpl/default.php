...
<form name="adminForm" action="index.php" method="post" id="adminForm">
	...
	<?php echo $vik->openCard(); ?>
		...
		<div class="span6">
			...
			<div class="row-fluid">
				<div class="span12">
					<?php echo $vik->openFieldset(JText::translate('VRMANAGEROOMCLOSURE1')); ?>
		...
		<div class="span6">
			<?php echo $vik->openFieldset(JText::translate('VRE_LANG_ORIGINAL')); ?>
				...
				<!-- NAME - Text -->
				<?php echo $vik->openControl(JText::translate('VRMANAGELANG2')); ?>
					<input type="text" value="<?php echo $this->escape($this->room->name); ?>" size="48" readonly tabindex="-1" />
				<?php echo $vik->closeControl(); ?>
				
				<!-- DESCRIPTION - Textarea -->
				<?php echo $vik->openControl(JText::translate('VRMANAGELANG3')); ?>
					<textarea class="full-width" style="height:300px;resize:vertical;" readonly tabindex="-1"><?php echo $this->room->description; ?></textarea>
				<?php echo $vik->closeControl(); ?>
	...
	<input type="hidden" name="id_room" value="<?php echo $this->room->id; ?>" />	
