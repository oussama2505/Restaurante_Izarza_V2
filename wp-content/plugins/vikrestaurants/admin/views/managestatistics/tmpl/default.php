...
echo JHtml::fetch(
	...
	[
		'title'       => JText::translate('VRE_ADD_POSITION'),
		'closeButton' => true,
		'keyboard'    => false,
...
$footer = '<button type="button" class="btn btn-success" id="widget-save-config" data-role="save">' . JText::translate('JAPPLY') . '</button>'
	. '<button type="button" class="btn btn-danger" id="widget-delete-btn" data-role="delete" style="float:right;">' . JText::translate('VRDELETE') . '</button>';

echo JHtml::fetch(
	'vrehtml.inspector.render',
	'widget-config-inspector',
	[
		'title'       => JText::translate('VRE_ADD_WIDGET'),
		'closeButton' => true,
		'keyboard'    => false,
		'footer'      => $footer,
		'width'       => 400,
