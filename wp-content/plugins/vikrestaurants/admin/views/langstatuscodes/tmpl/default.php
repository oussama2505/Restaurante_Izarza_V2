		...
		for ($i = 0; $i < count($rows); $i++)
		{
			...
			<tr class="row<?php echo $i % 2; ?>">
				...
				<td>
					...
					{
						?>
						<a href="index.php?option=com_vikrestaurants&amp;task=langstatuscode.edit&amp;cid[]=<?php echo (int) $row['id']; ?>">
							<?php echo $name; ?>
						</a>
						<?php
					}
...
?>
	...
	<input type="hidden" name="view" value="langstatuscodes" />
	<input type="hidden" name="id_status_code" value="<?php echo (int) $filters['id_status_code']; ?>" />
