...
class VikRestaurantsViewmenus extends JViewVRE
{
	...
	function display($tpl = null)
	{
		...
		/**
		 * It is possible to lean on the "onBeforeListQueryMenus" plugin event
	...
	private function addToolBar()
	{
		...
		JToolbarHelper::title(JText::translate('VRMAINTITLEVIEWMENUS'), 'vikrestaurants');
		...
		{
			JToolbarHelper::deleteList(VikRestaurants::getConfirmSystemMessage(), 'menu.delete');
		}
	}
