 ...
 * called "onDisplayViewTkorderinfo". The event method receives the
...
<div class="order-container takeaway">
	...
	<div class="order-left-box">
		...
		<!-- {"rule":"customizer","event":"onDisplayViewTkorderinfo","key":"main.bottom","type":"field"} -->
		...
		if (isset($this->addons['main.bottom']))
		{
			...
			// unset main bottom form to avoid displaying it twice
