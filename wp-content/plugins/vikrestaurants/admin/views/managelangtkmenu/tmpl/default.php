...
<form name="adminForm" action="index.php" method="post" id="adminForm">
	...
	<?php echo $vik->openCard(); ?>
				...
				<div class="span12">
					<?php echo $vik->openFieldset(JText::translate('JDETAILS')); ?>
						...
						<?php echo $vik->openControl(JText::translate('JFIELD_ALIAS_LABEL')); ?>
							<input type="text" name="alias" value="<?php echo $this->escape($this->translation->alias); ?>" size="48" />
						<?php echo $vik->closeControl(); ?>
		...
		<div class="span6">
			<?php echo $vik->openFieldset(JText::translate('VRE_LANG_ORIGINAL')); ?>
				...
				<?php echo $vik->openControl(JText::translate('VRMANAGELANG2')); ?>
					<input type="text" value="<?php echo $this->escape($this->menu->title); ?>" size="48" readonly tabindex="-1" />
				<?php echo $vik->closeControl(); ?>

				<!-- ALIAS - Text -->

				<?php echo $vik->openControl(JText::translate('JFIELD_ALIAS_LABEL')); ?>
					<input type="text" value="<?php echo $this->escape($this->menu->alias); ?>" size="48" readonly tabindex="-1" />
				<?php echo $vik->closeControl(); ?>
				
				<!-- DESCRIPTION - Textarea -->

				<?php echo $vik->openControl(JText::translate('VRMANAGELANG3')); ?>
					<textarea class="full-width" style="height:300px;resize:vertical;" readonly tabindex="-1"><?php echo $this->menu->description; ?></textarea>
				<?php echo $vik->closeControl(); ?>
	...
	<input type="hidden" name="id_menu" value="<?php echo $this->menu->id; ?>" />	
