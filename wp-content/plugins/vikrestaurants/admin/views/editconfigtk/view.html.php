...
/**
 * VikRestaurants take-away configuration view.
 *
 * @since 1.9
 */
class VikRestaurantsVieweditconfigtk extends JViewVRE
{	
	/**
	...
	private function addToolBar()
	{
		...
		JToolbarHelper::title(JText::translate('VRMAINTITLECONFIGTK'), 'vikrestaurants');

		if (JFactory::getUser()->authorise('core.access.config', 'com_vikrestaurants'))
		{
			JToolbarHelper::apply('configtk.save', JText::translate('VRSAVE'));
		}
