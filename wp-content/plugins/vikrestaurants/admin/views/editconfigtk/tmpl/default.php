 ...
 * called "onDisplayViewConfigtk". The event method receives the
...
$this->selectedTab = JFactory::getApplication()->input->cookie->get('vikrestaurants_configtk_tab', 1, 'uint');
...
<!-- {"rule":"customizer","event":"onDisplayViewConfigtk","type":"tab"} -->

<!-- SCRIPT -->

<?php
echo JLayoutHelper::render('configuration.script', ['suffix' => 'tk']);
?>
