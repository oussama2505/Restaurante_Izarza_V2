...
<form name="adminForm" action="index.php" method="post" id="adminForm">
	...
	<?php echo $vik->openCard(); ?>
		...
		<div class="span6">
			<?php echo $vik->openFieldset(JText::translate('VRE_LANG_ORIGINAL')); ?>
				...
				<?php echo $vik->openControl(JText::translate('VRMANAGELANG2')); ?>
					<input type="text" value="<?php echo $this->escape($this->attribute->name); ?>" size="48" readonly tabindex="-1" />
				<?php echo $vik->closeControl(); ?>
				
				<!-- DESCRIPTION - Textarea -->

				<?php echo $vik->openControl(JText::translate('VRMANAGELANG3')); ?>
					<textarea class="full-width" style="height:300px;resize:vertical;" readonly tabindex="-1"><?php echo $this->attribute->description; ?></textarea>
				<?php echo $vik->closeControl(); ?>
	...
	<input type="hidden" name="id_attribute" value="<?php echo $this->attribute->id; ?>" />	
