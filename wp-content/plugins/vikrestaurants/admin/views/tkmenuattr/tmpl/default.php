...
if ($canOrder && $canEditState)
{
	...
	JHtml::fetch('vrehtml.scripts.sortablelist', 'menuattrList', 'adminForm', $this->orderDir, $saveOrderingUrl);
}
 ...
 * called "onDisplayViewTkmenuattrList". The event method receives the
...
<form action="index.php?option=com_vikrestaurants" method="post" name="adminForm" id="adminForm">
	...
	<div class="btn-toolbar" style="height: 32px;">
		...
		<!-- {"rule":"customizer","event":"onDisplayViewTkmenuattrList","type":"search","key":"search"} -->
	...
	<div class="btn-toolbar hidden-phone" id="vr-search-tools" style="height: 32px;<?php echo ($is_searching ? '' : 'display: none;'); ?>">
		...
		<!-- Define role to detect the supported hook -->
		<!-- {"rule":"customizer","event":"onDisplayViewTkmenuattrList","type":"search","key":"filters"} -->
...
else
{
	...
	<!-- Define role to detect the supported hook -->
	<!-- {"rule":"customizer","event":"onDisplayTkmenuattrTableTH","type":"th"} -->

	<!-- Define role to detect the supported hook -->
	<!-- {"rule":"customizer","event":"onDisplayTkmenuattrTableTD","type":"td"} -->
		...
		<?php echo $vik->openTableHead(); ?>
			<tr>
				...
				<th class="<?php echo $vik->getAdminThClass('left'); ?>" width="30%" style="text-align: left;">
					<?php echo JHtml::fetch('vrehtml.admin.sort', 'VRMANAGETKMENUATTR1', 'a.name', $this->orderDir, $this->ordering); ?>
				</th>

				<!-- PUBLISHED -->
				
				<th class="<?php echo $vik->getAdminThClass(); ?>" width="5%" style="text-align: center;">
					<?php echo JText::translate('VRMANAGETKMENUATTR3'); ?>
				</th>
				...
				<th class="<?php echo $vik->getAdminThClass('hidden-phone'); ?>" width="5%" style="text-align: center;">
					<?php echo JText::translate('VRMANAGETKMENUATTR4'); ?>
				</th>
			...
			<tr class="row<?php echo ($i % 2); ?>">
				...
				<td>
					<div class="td-primary">
						...
						{
							?>
							<a href="index.php?option=com_vikrestaurants&amp;task=tkattribute.edit&amp;cid[]=<?php echo (int) $row['id']; ?>">
								<?php echo $row['name']; ?>
							</a>
							<?php
						}
				...
				<td style="text-align: center;">
					<?php echo JHtml::fetch('vrehtml.admin.stateaction', $row['published'], $row['id'], 'tkattribute.publish', $canEditState); ?>
				</td>
				...
				<td style="text-align: center;" class="hidden-phone">
					...
					{
						?>
						<img src="<?php echo VREMEDIA_SMALL_URI . $row['icon']; ?>" style="max-height: 28px;" />
						<?php
					}
					?>
				</td>
				...
				<?php if ($multi_lang && $canEdit): ?>
					<td style="text-align: center;">
						<a href="index.php?option=com_vikrestaurants&amp;view=langtkattributes&amp;id_attribute=<?php echo (int) $row['id']; ?>">
							<?php
