...
<form name="adminForm" action="index.php" method="post" id="adminForm">
	...
	<?php echo $vik->openCard(); ?>
		...
		<div class="span6">
			...
			<div class="row-fluid">
				<div class="span12">
					<?php echo $vik->openFieldset(JText::translate('VRMANAGERESERVATION20')); ?>
			...
			<div class="row-fluid">
				<div class="span12">
					...
					echo $editor->display('prenote', $this->translation->prenote, '100%', 550, 70, 20);
			...
			<div class="row-fluid">
				<div class="span12">
					...
					echo $editor->display('note', $this->translation->note, '100%', 550, 70, 20);
					echo $vik->closeFieldset();
					?>
				</div>
			</div>
		...
		<div class="span6">
			<?php echo $vik->openFieldset(JText::translate('VRE_LANG_ORIGINAL')); ?>
				...
				<!-- NAME - Text -->
				<?php echo $vik->openControl(JText::translate('VRMANAGELANG2')); ?>
					<input type="text" value="<?php echo $this->escape($this->payment->name); ?>" size="48" readonly tabindex="-1" />
				<?php echo $vik->closeControl(); ?>
				
				<!-- NOTES BEFORE PURCHASE - Textarea -->
				<?php echo $vik->openControl(JText::translate('VRMANAGEPAYMENT11')); ?>
					<textarea class="full-width" style="height:300px;resize:vertical;" readonly tabindex="-1"><?php echo $this->payment->prenote; ?></textarea>
				<?php echo $vik->closeControl(); ?>

				<!-- NOTES AFTER PURCHASE - Textarea -->
				<?php echo $vik->openControl(JText::translate('VRMANAGEPAYMENT7')); ?>
					<textarea class="full-width" style="height:300px;resize:vertical;" readonly tabindex="-1"><?php echo $this->payment->note; ?></textarea>
				<?php echo $vik->closeControl(); ?>
	...
	<input type="hidden" name="id_payment" value="<?php echo (int) $this->payment->id; ?>" />	
