...
class VikRestaurantsViewlangrooms extends JViewVRE
{
	...
	private function addToolBar()
	{
		...
		{
			JToolbarHelper::addNew('langroom.add');
		}

		if ($user->authorise('core.edit', 'com_vikrestaurants'))
		{
			JToolbarHelper::editList('langroom.edit');
		}

		if ($user->authorise('core.delete', 'com_vikrestaurants'))
		{
			JToolbarHelper::deleteList(VikRestaurants::getConfirmSystemMessage(), 'langroom.delete');
		}
	}
}
