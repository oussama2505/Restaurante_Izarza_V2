...
<div class="order-fields">
	...
	<?php if ($this->order->payment_charge > 0): ?>
		...
		<div class="order-field payment-charge">
			...
			<label>
				<?php echo JText::translate('VRINVPAYCHARGE'); ?>
			</label>
	...
	<?php if ($this->order->total_tax > 0): ?>
		...
		<div class="order-field total-tax">
			...
			<label>
				<?php echo JText::translate('VRINVTAXES'); ?>
			</label>
	...
	<?php if (!$this->order->bill_closed): ?>
		...
		<div class="order-field total-due">
			...
			<label>
				...
				if ($this->order->deposit > $this->order->tot_paid && $this->order->statusRole === 'APPROVED' && !$this->order->paid)
				{
					?>
					<i class="fas fa-exclamation-triangle warn hasTooltip" title="<?php echo $this->escape(JText::translate('VRORDERDEPNOTPAID')); ?>" style="margin-right: 4px;"></i>
					<?php
				}

				echo JText::translate('VRORDERINVDUE');
				?>
			</label>
	...
	<div class="order-field total-cost">
		...
		<label>
			...
			{
				?><i class="fas fa-check-circle ok hasTooltip" title="<?php echo $this->escape(JText::translate('VRMANAGERESERVATION11')); ?>" style="margin-right: 6px;"></i><?php
			}
			
			echo JText::translate('VRMANAGETKORDDISC1'); ?>
		</label>
