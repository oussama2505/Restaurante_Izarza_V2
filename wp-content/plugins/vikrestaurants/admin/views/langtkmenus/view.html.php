...
class VikRestaurantsViewlangtkmenus extends JViewVRE
{
	...
	private function addToolBar()
	{
		...
		{
			JToolbarHelper::addNew('langtkmenu.add');
		}

		if ($user->authorise('core.edit', 'com_vikrestaurants'))
		{
			JToolbarHelper::editList('langtkmenu.edit');
		}

		if ($user->authorise('core.delete', 'com_vikrestaurants'))
		{
			JToolbarHelper::deleteList(VikRestaurants::getConfirmSystemMessage(), 'langtkmenu.delete');
		}
	}
}
