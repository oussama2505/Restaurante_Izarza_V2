			...
			<tr class="row<?php echo $i % 2; ?>">
				...
				<td>
					<div class="td-primary">
						...
						{
							?>
							<a href="index.php?option=com_vikrestaurants&amp;task=langtkmenu.edit&amp;cid[]=<?php echo (int) $row['id']; ?>">
								<?php echo $name; ?>
							</a>
							<?php
						}
...
?>
	...
	<input type="hidden" name="id_menu" value="<?php echo (int) $filters['id_menu']; ?>" />
