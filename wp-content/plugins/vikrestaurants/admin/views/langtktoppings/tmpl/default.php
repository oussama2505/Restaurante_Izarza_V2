...
else
{
	...
	<table cellpadding="4" cellspacing="0" border="0" width="100%" class="<?php echo $vik->getAdminTableClass(); ?>">
		...
		for ($i = 0; $i < count($rows); $i++)
		{
			...
			$desc = $row['description'] ? $row['description'] : JText::translate('JOPTION_USE_DEFAULT');
			?>
			<tr class="row<?php echo $i % 2; ?>">
				...
				<td>
					<div class="td-primary">
						...
						{
							?>
							<a href="index.php?option=com_vikrestaurants&amp;task=langtktopping.edit&amp;cid[]=<?php echo (int) $row['id']; ?>">
								<?php echo $name; ?>
							</a>
							<?php
						}
...
?>
	...
	<input type="hidden" name="id_topping" value="<?php echo (int) $filters['id_topping']; ?>" />
