...
class VikRestaurantsViewlangtktoppings extends JViewVRE
{
	...
	private function addToolBar()
	{
		...
		{
			JToolbarHelper::addNew('langtktopping.add');
		}

		if ($user->authorise('core.edit', 'com_vikrestaurants'))
		{
			JToolbarHelper::editList('langtktopping.edit');
		}

		if ($user->authorise('core.delete', 'com_vikrestaurants'))
		{
			JToolbarHelper::deleteList(VikRestaurants::getConfirmSystemMessage(), 'langtktopping.delete');
		}
	}
}
