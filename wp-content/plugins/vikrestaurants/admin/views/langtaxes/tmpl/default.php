			...
			<tr class="row<?php echo $i % 2; ?>">
				...
				<td>
					<div class="td-primary">
						...
						{
							?>
							<a href="index.php?option=com_vikrestaurants&amp;task=langtax.edit&amp;cid[]=<?php echo (int) $row['id']; ?>">
								<?php echo $name; ?>
							</a>
							<?php
						}
...
?>
	...
	<input type="hidden" name="view" value="langtaxes" />
	<input type="hidden" name="id_tax" value="<?php echo (int) $filters['id_tax']; ?>" />
