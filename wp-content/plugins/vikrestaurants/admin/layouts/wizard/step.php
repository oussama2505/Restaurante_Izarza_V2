...
<div class="wizard-step">
	...
	<div class="wizard-step-body">
		...
		else
		{
			...
			<div class="wizard-step-body-dep">
				<?php echo JText::translate('VRWIZARDDEPEND'); ?>
	...
	<div class="wizard-step-footer-bar">
		...
		if ($step->isCompleted())
		{
			...
			?>
			<button type="button" class="btn pull-left" data-role="dismiss"><?php echo JText::translate('VRWIZARDBTNDISMISS'); ?></button>
			<?php
		}
		else
		{
			if ($step->canIgnore())
			{
				...
				?>
				<button type="button" class="btn pull-left" data-role="ignore"><?php echo JText::translate('VRWIZARDBTNIGNORE'); ?></button>
				<?php
			}
