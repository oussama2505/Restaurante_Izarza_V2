...
/**
 * VikRestaurants status code table.
 *
 * @since 1.9
 */
class VRETableStatuscode extends JTableVRE
{
	/**
	 * Class constructor.
	 *
	...
	{
		parent::__construct('#__vikrestaurants_status_code', 'id', $db);
	...
	public function check()
	{
		...
		if (!empty($this->code))
		{
			...
			if ($dbo->getNumRows())
			{
				...
				$this->setError(JText::translate('VRSTATUSCODEUNIQUEERR'));
